...
def documentUnknownError(exception_error, message_destination=print):
        
        """
        Document an unknown exception error that occurred during the program execution.
        :param error: The error message to display to the user
        :param message_destination: The function to call to output the message
        """
        
        output_message("An unknown error occurred during this operation\n", message_destination)
        output_message("The exception error is shown below\n", message_destination)
        # Provide the error and traceback
        output_message(str(exception_error) + "\n", message_destination)
        output_message("Traceback:\n" + traceback.format_exc(), message_destination)
